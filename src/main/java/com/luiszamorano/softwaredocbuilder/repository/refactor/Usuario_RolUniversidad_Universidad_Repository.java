...
public interface Usuario_RolUniversidad_Universidad_Repository extends JpaRepository<Usuario_RolUniversidad_Universidad, Usuario_RolUniversidad_Universidad_PK> {
    ...
    List<Usuario_RolUniversidad_Universidad> findByUsuarioRolUniversidadUniversidadPkUniversidadAndUsuarioRolUniversidadUniversidadPkRolUniversidad(
            Universidad universidad,
            RolUniversidad rolUniversidad
    );
